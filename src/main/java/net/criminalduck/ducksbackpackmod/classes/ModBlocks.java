...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BACKPACK_WORKBENCH =
            registerBlock("backpack_workbench", () -> new Block(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
